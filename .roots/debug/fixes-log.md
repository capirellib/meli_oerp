...
### 9 jul 2026 — fix: BUG-009 fecha real de ML en `date_order` + BUG-007 cancelación explícita en `update_order_status` (v19.0.26.68) — promoción Dannok `0eff11d`
...
### 30 jun 2026 — fix(perms): la creación on-the-fly de producto al importar una orden corre con sudo (v19.0.26.54) [Deco/KPI 526, suite-wide]
...
### 27 jun 2026 — fix(chatter): idempotencia en message_post anti-spam — PRODUCTO NO ENCONTRADO + Condition not met (v19.0.26.52) [#415 NipSkin/Inity 520]
...
---
### 25 jun 2026 — fix(category): cache RAM de meli_get_category devolvia ids huerfanos → FK violation meli_category (v26.50) [#410 Solsun]
...
- **Síntoma:** QWebException al renderizar el reporte de factura+envío en Odoo 19+.
